<template>
  <div class="flex-1 flex gap-2 h-full w-full">
    <div class="flex-1 flex flex-col h-full animate-[fade-in-up_0.5s_ease-out]">
      <TwmWindow title="contact" :isActive="true" class="h-full shadow-xl">
        <div class="h-full w-full bg-[#1e1e2e] text-[#cdd6f4] p-4 font-mono text-sm flex flex-col items-center justify-center gap-6 relative">
          ...
          <!-- Active service simulation -->
          <div class="w-full max-w-lg mb-8 text-[#a6adc8] flex flex-col gap-1">
            <div class="flex gap-2">
              <span class="text-[#a6e3a1]">●</span> <span class="text-[#cdd6f4] font-bold">social-links.service - Portfolio Hub Connections</span>
            </div>
            <div class="ml-4">
              ...
              <span>  Main PID: 1337 (node)</span><br>
            </div>
          </div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 w-full max-w-3xl">
            ...
            <a href="#" class="flex flex-col items-center gap-3 p-6 bg-[#181825] border border-[#313244] hover:border-[#89dceb] rounded-lg transition-colors group cursor-pointer shadow-md">
